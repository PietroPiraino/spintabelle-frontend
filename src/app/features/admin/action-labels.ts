...
export const ACTION_LABELS: Record<string, string> = {
  ...
  'send-conteggio-prospectus': 'Prospetto inviato al giocatore',
  'credit-rakeback-points': 'Punti accreditati dal rakeback',
  'add-partner-transfer': 'Versamento fra casse registrato',
  'delete-partner-transfer': 'Versamento fra casse rimosso',
